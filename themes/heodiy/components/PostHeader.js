      ...
      <style jsx>{`
        .coverdiv:after {
          ...
          box-shadow: 110px -130px 500px 100px
            ${isDarkMode ? '#CA8A04' : '#3B82F6'} inset;
        }
      `}</style>

      <div
        className={`${isDarkMode ? 'bg-[#CA8A04]' : 'bg-[#3B82F6]'} absolute top-0 w-full h-full py-10 flex justify-center items-center`}>
        {/* 文章背景图 */}
        <div
        ...
        <div
          id='post-info'
          className='absolute top-24 z-10 flex flex-col space-y-4 lg:-mt-12 w-full max-w-[86rem] px-5'>
          {/* 分类+标签 */}
