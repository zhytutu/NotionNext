          ...
          <SmartLink href={post?.href} passHref legacyBehavior>
            <div
              ...
              <LazyImage
                ...
                alt={post?.title}
                className='h-full w-full object-cover blur-[4px] group-hover:scale-105 group-hover:brightness-75 transition-all duration-500 ease-in-out' //宽高都调整为自适应,保证封面居中
              />
            </div>
          </SmartLink>
        )}
